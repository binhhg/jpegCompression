...
class GUI:
    ...
    def setWindow(self):
        ...
        # Display infor, title
        tk.Label(self.root, text="University of Information Technology", font=(self.font, 10), fg=self.textColor).place(
            x=131, y=3)
        tk.Label(self.root, text="Multimedia Computing-CS232.K23.KHCL", font=(self.font, 10), fg=self.textColor).place(
            x=119, y=23)
    ...
    def drawUI(self):
        ...
        btnOpenFile = tk.Button(self.root, text="Select File", width=10, height=2, bg=self.buttonColor, fg="#FFFFFF",
